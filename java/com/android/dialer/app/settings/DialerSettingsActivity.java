...
public class DialerSettingsActivity extends AppCompatPreferenceActivity {
  ...
  public void onBuildHeaders(List<Header> target) {
    ...
    callRecordingHeader.titleRes = R.string.call_recording_category_title;
    callRecordingHeader.fragment = CallRecordingFragment.class.getName();
    callRecordingHeader.id = R.id.settings_call_recording;
